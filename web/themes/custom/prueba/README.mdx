...
prueba theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of prueba theme and run the following commands:
`nvm use`
...
`drush en prueba -y`
`drush config-set system.theme default prueba -y`
