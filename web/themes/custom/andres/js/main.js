...
(() => {
  document.addEventListener('DOMContentLoaded', () => {
    ...
    for (const toastEl of toastElList) {
      const toast = new (bootstrap_js_dist_toast__WEBPACK_IMPORTED_MODULE_0___default())(toastEl, { autohide: false });
      toast.show();
    }
  });
})();
...
(() => {
  ...
  const tooltipList = [...tooltipTriggerList].map(
    (tooltipTriggerEl) => new (bootstrap_js_dist_tooltip__WEBPACK_IMPORTED_MODULE_0___default())(tooltipTriggerEl),
  );
})();
