...
prueba2 theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of prueba2 theme and run the following commands:
`nvm use`
...
`drush en prueba2 -y`
`drush config-set system.theme default prueba2 -y`
